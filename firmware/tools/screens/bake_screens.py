...
# screens that say something a plate can't: the setup steps and the three error
# states (the gray build's pill bands, promoted to whole screens). The splash
# and the boot-stage screens are not baked — firmware skips a screen with no
# data. The art is monochrome, so the screens use black and white ink only
...
EE02_SCREENS = [
    ("SPLASH", None), ("BOOT_WIFI", None), ("BOOT_BIRDNET", None), ("BOOT_DOWNLOAD", None),
    ("SETUP", screen_setup()),
...
def write_header_ee02():
    from featherframe.render import spectra
    L = ["// GENERATED by firmware/tools/screens/bake_screens.py — do not edit by hand.",
         "// EE02 (13.3\" Spectra 6) screens: setup, the error states and low battery, black and",
